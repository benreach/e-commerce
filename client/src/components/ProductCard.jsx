  ...
  return (
    product && (
      <div
        ...
        className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-40 sm:min-w-45 max-w-56 w-full"
      >
          ...
          <div className="flex items-end justify-between mt-3">
            ...
            <div className="text-primary" onClick={(e) => e.stopPropagation}>
              {!cartItems[product._id] ? (
                ...
                >
                  <img src={assets.cart_icon} alt="cart" width={25} />
                  Add
                </button>
              ) : (
