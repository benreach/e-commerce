...
const ProductDetail = () => {
  ...
  useEffect(() => {
    if (products.length > 0) {
      ...
      setRelatedProduts(productsCopy.slice(0, 5));
    }
  }, [products]);
      ...
      <div className="max-w-6xl w-full px-6 mt-16">
            ...
            <div className="flex items-center gap-0.5 mt-1">
              {Array(5)
                ...
                .map((_, i) => (
                  <img
                    key={i}
                    src={i < 4 ? assets.star : assets.starDull}
                    alt=""
                    width={15}
                  />
                ))}
        ...
        <div className="flex flex-col items-center mt-20">
          <div className="flex flex-col items-center w-max">
            ...
            <div className="w-20 h-0 bg-primary rounded-full mt-2"></div>
          </div>
          ...
          rounded text-primary hover:bg-primary/10 transition delay-300"
          >
            See more
          </button>
        </div>
